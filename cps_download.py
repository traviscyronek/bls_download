...
Date:    28 May 2018
Purpose: To download and rename monthly CPS files. A big annoyance is that the
...
out_dir_f = '/Users/traviscyronek/Google Drive/data/bls/cps/raw/'
out_dir_d = '/Users/traviscyronek/Google Drive/data/bls/cps/dicts/'
...
def downloader(out_dir, what_to_dl):
    ...
    if what_to_dl == 'data':
        site   = 'http://www.nber.org/data/cps_basic.html' # TODO: go to this link to find the new url
