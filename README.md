...
This script downloads selected series from various BLS programs using the BLS API v2.0. In order to work, you'll need to register a "key" which can be done at the following link. https://data.bls.gov/registrationEngine/
